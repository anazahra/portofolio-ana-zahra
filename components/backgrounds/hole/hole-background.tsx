  ...
  return (
    <div
      className={cn(
        ...
        'after:content-[""] after:absolute after:z-[5] after:top-1/2 after:left-1/2 after:block after:size-full after:[background:radial-gradient(ellipse_at_50%_75%,#0066ff_20%,transparent_75%)] after:[transform:translate3d(-50%,-50%,0)] after:mix-blend-overlay',
        className,
      )}
    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          ...
          "dark:[background:linear-gradient(20deg,#00f8f1,#0066ff20_16.5%,#7c3aed_33%,#7c3aed20_49.5%,#00f8f1_66%,#00f8f160_85.5%,#0066ff_100%)_0_100%_/_100%_200%] [background:linear-gradient(20deg,#00f8f1,#ffbd1e40_16.5%,#fe848f_33%,#fe848f40_49.5%,#00f8f1_66%,#00f8f180_85.5%,#ffbd1e_100%)_0_100%_/_100%_200%]",
        )}
